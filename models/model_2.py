...
def main():
    ...
    unused_cols = ['id', 'Title', 'release_date', 'Date', 'Month_Label', 'Continent']
    ...
    unused_num_cols = ['Rank', 'Target', 'Popularity_Lag_2', 'Popularity_Lag_3', 'Danceability', 'Energy', 'Speechiness','Acousticness','Valence', 'Loudness_Normalized','Instrumentalness_Binary']
